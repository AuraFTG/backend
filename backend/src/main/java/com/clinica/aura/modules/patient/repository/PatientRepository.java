...
public interface PatientRepository extends JpaRepository<PatientModel, Long> {
    ...
    Page<PatientModel> findByEliminadoFalse(Pageable pageable);

    Optional<PatientModel> findByIdAndEliminadoFalse(Long id);

    // se usa en el metodo buscar por dni
    Optional<PatientModel> findByPersonDniAndEliminadoFalse(String dni);
